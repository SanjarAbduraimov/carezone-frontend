            ...
            <div className="relative mx-auto max-w-7xl px-4 py-12">
              <div className="grid gap-8 md:grid-cols-4">
                <div className="md:col-span-2">
                  ...
                  <p className="text-slate-600 text-sm max-w-md mb-4 leading-relaxed">
                    O&apos;zbekistondagi eng yaxshi shifokorlar va klinikalar. Sog&apos;liq va salomatlik uchun ishonchli manbangiz.
                  </p>
                  <div className="inline-flex items-center gap-2 px-3 py-2 bg-amber-50 border-2 border-amber-200 rounded-xl">
                    <svg className="w-4 h-4 text-amber-600 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
                    </svg>
                    <span className="text-xs font-semibold text-amber-700">Tibbiy maslahat emas — faqat ma&apos;lumot uchun</span>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <ul className="space-y-3 text-sm">
                    <li>
                      <Link href="/doctors" className="text-slate-600 hover:text-emerald-600 transition-colors flex items-center gap-2 group">
                        <span className="w-1.5 h-1.5 rounded-full bg-slate-300 group-hover:bg-emerald-500 transition-colors"></span>
                        Shifokorlar
                      </Link>
                    </li>
                    <li>
                      <Link href="/clinics" className="text-slate-600 hover:text-emerald-600 transition-colors flex items-center gap-2 group">
                        <span className="w-1.5 h-1.5 rounded-full bg-slate-300 group-hover:bg-emerald-500 transition-colors"></span>
                        Klinikalar
                      </Link>
                    </li>
                    <li>
                      <Link href="/blog" className="text-slate-600 hover:text-emerald-600 transition-colors flex items-center gap-2 group">
                        <span className="w-1.5 h-1.5 rounded-full bg-slate-300 group-hover:bg-emerald-500 transition-colors"></span>
                        Blog
                      </Link>
                    </li>
                    <li>
                      <a href="/privacy" className="text-slate-600 hover:text-emerald-600 transition-colors flex items-center gap-2 group">
                        <span className="w-1.5 h-1.5 rounded-full bg-slate-300 group-hover:bg-emerald-500 transition-colors"></span>
                        Maxfiylik
                      </a>
                    </li>
                    <li>
                      <a href="/terms" className="text-slate-600 hover:text-emerald-600 transition-colors flex items-center gap-2 group">
                        <span className="w-1.5 h-1.5 rounded-full bg-slate-300 group-hover:bg-emerald-500 transition-colors"></span>
                  ...
                  <ul className="space-y-3 text-sm">
                    <li>
                      ...
                      >
                        ...
                        <span className="text-slate-700 font-medium group-hover:text-blue-600">Telegram</span>
                      </a>
                    </li>
                    <li>
                      <a 
                      ...
                      >
                        <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-slate-700 to-slate-900 flex items-center justify-center shadow-sm group-hover:scale-110 transition-transform">
                          <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 24 24">
                            <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                          </svg>
                        </div>
                        <span className="text-slate-700 font-medium group-hover:text-slate-900">X (Twitter)</span>
                      </a>
                    </li>
                    <li>
                      <a 
                      ...
                      >
                        ...
                        <span className="text-slate-700 font-medium group-hover:text-pink-600">Instagram</span>
                      </a>
                    </li>
                  </ul>
                </div>
